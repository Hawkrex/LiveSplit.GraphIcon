...
{
    public class GraphIconSeparatorComponent : IComponent
    {
        ...
        public GraphIconSeparatorComponent(GraphIconSettings settings)
        {
        ...
        public void DrawVertical(Graphics g, LiveSplitState state, float width, Region clipRegion)
        {
            ...
            g.Clip = new Region();
            Line.LineColor = Settings.GraphSeparatorsColor;
